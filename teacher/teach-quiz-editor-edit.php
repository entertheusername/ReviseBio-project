...
<!--questions-->
<main>
    <form id="form" name="quizform" enctype="multipart/form-data" action="teach-quiz-editor-edit.php" method="post">
        ...
        <textarea name="nq-desc" maxlength="200" placeholder="Quiz Description" class="nq" style="resize: none; height: 100px;" required><?php $quizDesc = trim(str_replace(["\r", "\n"], '', $quizRow['QuizDesc'])); echo $quizDesc;?></textarea>
